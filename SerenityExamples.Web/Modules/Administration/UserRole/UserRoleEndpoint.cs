using MyRepository = SerenityExamples.Administration.Repositories.UserRoleRepository;
using MyRow = SerenityExamples.Administration.UserRoleRow;

namespace SerenityExamples.Administration.Endpoints;
